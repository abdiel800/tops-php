...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-3">
        ...
        <br><a href="./?module=user&view=register" class="btn btn-primary">Registrarse</a>
    </div>
    <div class="col-md-3">
...
<?php Core::redir("./?module=user&view=login"); ?>
